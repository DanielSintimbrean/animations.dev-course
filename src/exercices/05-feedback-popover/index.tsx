      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className={css["feedback-popover"]}
              ...
              {formState === "success" ? (
                ...
                >
                  <textarea
                    ...
                    required
                  />
                  <div className={css["feedback-footer"]}>
                    <svg
                      className={css["dotted-line"]}
                      width="352"
                      height="2"
                      viewBox="0 0 352 2"
                      fill="none"
                    ...
                    <div className={css["half-circle-left"]}>
                      <svg
                        width="6"
                        height="12"
                        viewBox="0 0 6 12"
                    ...
                    <div className={css["half-circle-right"]}>
                      <svg
                        width="6"
                        height="12"
                        viewBox="0 0 6 12"
